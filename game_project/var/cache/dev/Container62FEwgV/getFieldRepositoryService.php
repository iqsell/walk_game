 ...
 */
class getFieldRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FieldRepository' shared autowired service.
     *
     * @return \App\Repository\FieldRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FieldRepository.php';

        return $container->privates['App\\Repository\\FieldRepository'] = new \App\Repository\FieldRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
